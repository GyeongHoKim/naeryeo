...
| 제공자 | 설명 | 필요한 것 |
| --- | --- | --- |
| **자체 호스팅 (MOTIS)** | 오픈소스 경로 검색 엔진을 직접 운영합니다. 계정도 API 키도 없고, 호출 횟수 제한과 과금 정책에서 자유로우며, 검색 내용이 외부로 나가지 않습니다 | Docker Compose ([자체 호스팅 안내](./docs/self-hosting.md)) |
| **ODsay** | 상용 대중교통 API입니다 | [ODsay](https://lab.odsay.com) 앱키 |
